...
import { brand, brandModel } from "../page";
...
export default function AdForm({ initialData, brands, brandModels }: AdFormProps) {
                        ...
                        <FormField 
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select
                                        disabled={loading}                                            
                                        onValueChange={(value) => {field.onChange(value); setCurrentBrandId(value)}}
                                        value={field.value}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        ...
                                        <SelectContent className="max-h-64 overflow-y-scroll" key={currentBrandId}>
                                                {brandModels.filter((brandModel) => brandModel.brandId === currentBrandId).map((brandModel) => (
                                                    <SelectItem
                                                        key={brandModel.code}
                                                        value={brandModel.code}
                                                    >
                                                        {brandModel.name}
                                                    </SelectItem>
                                                ))}
