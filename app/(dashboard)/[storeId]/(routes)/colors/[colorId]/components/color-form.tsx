...
export default function ColorForm({ initialData }: ColorFormProps) {
    ...
    const description = initialData ? "Edite as informações da cor" : "Preencha as informações da cor"
    const toastMessage = initialData ? "Alterações salvas com sucesso!" : "Cor criada com sucesso!"
