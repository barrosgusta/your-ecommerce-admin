...
export default function CategoryForm({ initialData, billboards }: CategoryFormProps) {
    ...
    const description = initialData ? "Edite as informações da categoria" : "Preencha as informações da categoria"
    const toastMessage = initialData ? "Alterações salvas com sucesso!" : "Categoria criada com sucesso!"
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error("Ocorreu um erro ao excluir a categoria. Certifique-se que ela não está sendo usada em nenhum produto.");
        } finally {
            setLoading(false);
            setOpen(false);
        }
